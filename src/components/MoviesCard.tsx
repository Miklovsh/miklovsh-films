  ...
  return (
    <div className="Movies-сard">
      <div className="movies-card__wrapper">
        <a className="movies-card__poster-link" href="#"><img className="movies-card__poster-img" src={url} alt="poster" /></a>
        <a className="movies-card__title-link" href="#"><h2 className="movies-card__title">{movie.title}</h2></a>
